...
?>
<h2 class="step_title_wrapper component_title <?php echo $is_toggled ? 'component_title_toggled' : ''; ?> <?php echo $component_title == 'Hidden' || $component_title == '' || strpos($component_title, 'Untitled') !== false ? 'd-none' : '' ?>" tabindex="-1" >
