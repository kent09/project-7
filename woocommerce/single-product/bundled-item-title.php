...
<h4 class="bundled_product_title product_title">
    <input class="bundled_product_checkbox" type="checkbox" name="<?php //echo $bundle_fields_prefix; ?>bundle_selected_optional_<?php echo $bundled_item->get_id(); ?>" value="" <?php checked( $bundled_item->is_optional_checked() && $bundled_item->is_in_stock(), true ); echo $bundled_item->is_in_stock() ? '' : 'disabled="disabled"' ; ?> />
    <?php
